...
public class BehaviorRebateService implements IBehaviorRebateService {
    final private IBehaviorRebateRepository behaviorRebateRepository;
    final private SendRebateMessageEvent sendRebateMessageEvent;

    public BehaviorRebateService(IBehaviorRebateRepository repository, SendRebateMessageEvent sendRebateMessageEvent) {
        this.behaviorRebateRepository = repository;
